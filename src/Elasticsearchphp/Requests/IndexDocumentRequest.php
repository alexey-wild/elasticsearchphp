    ...
    public function documents($values)
    {
        if ($values instanceof BatchCommandInterface) {
            ...
            if (!$isBatch) {
                ...
                throw new exceptions\BadResponseException("If an array is supplied, all elements must be a Command object.");
            }
            ...
            throw new exceptions\BadResponseException("Documents method only accepts arrays of Commands or BatchCommandInterface objects");
        }
