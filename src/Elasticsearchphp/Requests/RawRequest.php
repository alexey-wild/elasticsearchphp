 ...
 *
 * @method \Elasticsearchphp\Requests\RawRequest uri() uri(\string $value)
 * @method \Elasticsearchphp\Requests\RawRequest method() method(\int $value)
 */
class RawRequest extends Request
{
    ...
    {
        if (!isset($dispatcher)) {
            throw new exceptions\BadResponseException("Dispatcher argument required for RawRequest");
        }
