...
use Elasticsearchphp\responses\DeleteResponse;
...
class DeleteDocumentRequest extends Request
{
    ...
    {
        if (!isset($dispatcher)) {
            throw new \Elasticsearchphp\Exceptions\BadMethodCallException("Dispatcher argument required for IndexRequest");
        }
    ...
    public function document($id)
    {
        if (!$this->batch instanceof BatchCommand) {
            throw new \RuntimeException("Cannot delete a document from an external BatchCommandInterface");
        }
     ...
     *
     * @throws \RuntimeException
     * @return \Elasticsearchphp\Responses\DeleteResponse
     */
    ...
    /**
     * @param $response
     * @return \Elasticsearchphp\Responses\DeleteResponse|\Elasticsearchphp\Responses\Response
     */
