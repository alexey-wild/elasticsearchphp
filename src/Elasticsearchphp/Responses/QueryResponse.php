...
class QueryResponse extends Response implements \IteratorAggregate, \Countable
{
    ...
    public function __construct($response)
    {
        ...
        if (isset($this->responseData['hits']['total'])) $this->total = $this->responseData['hits']['total'];

        if (isset($this->responseData['hits']['max_score'])) $this->max_score = $this->responseData['hits']['max_score'];
